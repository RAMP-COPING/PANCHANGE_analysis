...
retro_ethnicity_plot <- plot_grid(retro_ethnicity_white, retro_ethnicity_non_white, labels = "AUTO")
...
This will plot the stacked bar charts of the gender, age, employment, ethnicity and diagnosis variables together.


```{r Plot histograms together}

#figure1 <- multi_panel_figure(columns = 3, rows = 3, panel_label_type = "none")
#figure1

#figure1 %>% 
#  fill_panel(retro_age_plot, column = 1, row = 1) %>% 
#  fill_panel(retro_gender_plot, column = 2, row = 1) %>% 
#  fill_panel(retro_employ_plot, column = 3, row = 1) %>% 
#  fill_panel(retro_ethnicity_plot, column = 1:3, row = 2) %>% 
#  fill_panel(retro_diagnosis_plot, column = 1:3, row = 3)
