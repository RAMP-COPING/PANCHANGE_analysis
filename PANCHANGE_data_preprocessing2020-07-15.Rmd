    ...
    bipolar_and_schizophrenia_numeric =
      case_when(
        psychotic_disorders_numeric == 1 &
          mhd.mania_hypomania_bipolar_or_manicdepression == 1 ~ 0,
        psychotic_disorders_numeric == 1 &
          mhd.mania_hypomania_bipolar_or_manicdepression == 1 ~ 1,
        psychotic_disorders_numeric == 1 &
          mhd.mania_hypomania_bipolar_or_manicdepression == 0 ~ 2,
        psychotic_disorders_numeric == 0 &
          mhd.mania_hypomania_bipolar_or_manicdepression == 1 ~ 3
      )
  )
