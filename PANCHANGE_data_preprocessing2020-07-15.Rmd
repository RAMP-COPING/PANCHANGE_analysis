...
glad.dem.raw.id.unclean.numeric <- add_numeric(glad.dem.raw.id.unclean, exclude = exclude_cols)

# Check if factor columns have been added
colnames(glad.dem.raw.id.unclean.numeric)

# Dimensions before adding factor columns
dim(glad.dem.raw.id.unclean)
# Dimensions after adding factor columns
dim(glad.dem.raw.id.unclean.numeric)
```
...
length(
  which(
  glad.dem.raw.id.unclean$Age_uncleaned > age_upper_limit |
    glad.dem.raw.id.unclean$Age_uncleaned < age_lower_limit
     )
)
