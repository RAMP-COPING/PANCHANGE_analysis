...
glad.gad.raw.id$gad.sum_score_prepan_raw <- gad.scored_items_prepan$scores
...
glad.gad.raw.id <- glad.gad.raw.id %>%
  mutate(
...
pcl.scored_items_prepan <- scoreItems(keys = pcl.items_key_prepan,
                                        ...
                                        max = 5)
# Add in column to tibble
glad.pcl.raw.id$pcl.sum_score_prepan_raw <- pcl.scored_items_prepan$scores
...
phq.scored_items_prepan <- scoreItems(keys = phq.items_key_prepan,
                                        ...
                                        max = 3)
# Add in column to tibble
glad.phq.raw.id$phq.sum_score_prepan_raw <- phq.scored_items_prepan$scores
...
all times
```{r phq prepan sum score if missigng items set to NA - all times}
glad.phq.raw.id <- glad.phq.raw.id %>%
  mutate(
...
glad.phq.raw.id %>%
  descr(phq.sum_score_8items_prepan_raw, stats = "common")
...
gad.scored_items_retro <- scoreItems(keys = gad.items_key_retro,
                                        ...
                                        max = 3)
# Add in column to tibble
coping.glad.gad.raw.id$gad.sum_score_retro_raw <- gad.scored_items_retro$scores
...
gad.scored_items_base <- scoreItems(keys = gad.items_key_base,
                                        ...
                                        max = 3)
# Add in column to tibble
coping.glad.gad.raw.id$gad.sum_score_base_raw <- gad.scored_items_base$scores
...
pcl.scored_items_retro <- scoreItems(keys = pcl.items_key_retro,
                                     ...
                                     max = 1)
# Add in column to tibble
coping.glad.pcl.raw.id$pcl.sum_score_retro_raw <- pcl.scored_items_retro$scores
...
pcl.scored_items_base <- scoreItems(keys = pcl.items_key_base,
                                    ...
                                    max = 5)
# Add in column to tibble
coping.glad.pcl.raw.id$pcl.sum_score_base_raw <- pcl.scored_items_base$scores
...
phq.scored_items_retro <- scoreItems(keys = phq.items_key_retro,
                                     ...
                                     max = 3)
# Add in column to tibble
coping.glad.phq.raw.id$phq.sum_score_retro_raw <- phq.scored_items_retro$scores
...
phq.scored_items_base <- scoreItems(keys = phq.items_key_base,
                                    ...
                                    max = 3)
# Add in column to tibble
coping.glad.phq.raw.id$phq.sum_score_base_raw <- phq.scored_items_base$scores
...
ocir.scored_items_retro <- scoreItems(keys = ocir.items_key_retro,
                                     ...
                                     max = 4)
# Add in column to tibble
coping.glad.ocir.raw.id$ocir.sum_score_retro_raw <- ocir.scored_items_retro$scores
...
ocir.scored_items_base <- scoreItems(keys = ocir.items_key_base,
                                    ...
                                    max = 4)
# Add in column to tibble
coping.glad.ocir.raw.id$ocir.sum_score_base_raw <- ocir.scored_items_base$scores
