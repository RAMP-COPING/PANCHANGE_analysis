...
gad.scored_items_prepan <- scoreItems(keys = gad.items_key_prepan,
                                        items = gad.raw.id[gad.items_prepan],
                                        totals = TRUE, 
                                        missing = TRUE, 
                                        impute = 'none', 
                                        min = 0, 
...
gad.raw.id$gad.sum_score_prepan_raw <- gad.scored_items_prepan$scores
