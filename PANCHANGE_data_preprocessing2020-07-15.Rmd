...
#         ess.none  
  ...
  add_column(
    ess.insomnia = NA_real_,
    ess.narcolepsy = NA_real_,
    ess.rem_sleep_behaviour_disorder = NA_real_,
    ess.restless_legs_syndrome = NA_real_,
    ess.sleep_apnea = NA_real_,
    ess.sleep_terrors = NA_real_,
    ess.sleepwalking = NA_real_,
    ess.other = NA_real_,
    ess.none = NA_real_
    ) %>%
  add_numeric(., exclude = exclude_cols) %>%
