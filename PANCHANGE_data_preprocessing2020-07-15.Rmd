...
nbr.mhd.raw.id <- nbr.mhd.raw %>%
  ...
  select(
    ...
    mhd.psychological_overeating_or_bingeeating_unc
  ) %>%
  add_column(
...
mhd.raw.id <- mhd.raw.id %>%
  mutate(
    ...
    mhd.psychological_overeating_or_bingeeating_numeric =
      case_when(mhd.suspected_eating_disorder_diagnosed_numeric == "0" ~ 0,
                mhd.psychological_overeating_or_bingeeating_unc_numeric == "0" ~ 0,
                mhd.psychological_overeating_or_bingeeating_unc_numeric == "1" ~ 1)
    )
}
