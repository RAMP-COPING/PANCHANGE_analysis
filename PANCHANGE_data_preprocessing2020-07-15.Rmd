...
prepan.gad.raw.id$gad.sum_score_prepan_raw <- as.numeric(gad.scored_items_prepan$scores)
...
pcl.scored_items_prepan <- scoreItems(keys = pcl.items_key_prepan,
                                        ...
                                        max = 5)
# Add in column to tibble
prepan.pcl.raw.id$pcl.sum_score_prepan_raw <- as.numeric(pcl.scored_items_prepan$scores)
...
phq.scored_items_prepan <- scoreItems(keys = phq.items_key_prepan,
                                        ...
                                        max = 3)
# Add in column to tibble
prepan.phq.raw.id$phq.sum_score_prepan_raw <- as.numeric(phq.scored_items_prepan$scores)
...
gad.scored_items_retro <- scoreItems(keys = gad.items_key_retro,
                                        ...
                                        max = 3)
# Add in column to tibble
coping.gad.raw.id$gad.sum_score_retro_raw <- as.numeric(gad.scored_items_retro$scores)
...
gad.scored_items_base <- scoreItems(keys = gad.items_key_base,
                                        ...
                                        max = 3)
# Add in column to tibble
coping.gad.raw.id$gad.sum_score_base_raw <- as.numeric(gad.scored_items_base$scores)
...
pcl.scored_items_retro <- scoreItems(keys = pcl.items_key_retro,
                                     ...
                                     max = 1)
# Add in column to tibble
coping.pcl.raw.id$pcl.sum_score_retro_raw <- as.numeric(pcl.scored_items_retro$scores)
...
pcl.scored_items_base <- scoreItems(keys = pcl.items_key_base,
                                    ...
                                    max = 5)
# Add in column to tibble
coping.pcl.raw.id$pcl.sum_score_base_raw <- as.numeric(pcl.scored_items_base$scores)
...
phq.scored_items_retro <- scoreItems(keys = phq.items_key_retro,
                                     ...
                                     max = 3)
# Add in column to tibble
coping.phq.raw.id$phq.sum_score_retro_raw <- as.numeric(phq.scored_items_retro$scores)
...
phq.scored_items_base <- scoreItems(keys = phq.items_key_base,
                                    ...
                                    max = 3)
# Add in column to tibble
coping.phq.raw.id$phq.sum_score_base_raw <- as.numeric(phq.scored_items_base$scores)
...
ocir.scored_items_retro <- scoreItems(keys = ocir.items_key_retro,
                                     ...
                                     max = 4)
# Add in column to tibble
coping.ocir.raw.id$ocir.sum_score_retro_raw <- as.numeric(ocir.scored_items_retro$scores)
...
ocir.scored_items_base <- scoreItems(keys = ocir.items_key_base,
                                    ...
                                    max = 4)
# Add in column to tibble
coping.ocir.raw.id$ocir.sum_score_base_raw <- as.numeric(ocir.scored_items_base$scores)
...
if(RAMP == TRUE){
ramp.respiratory.raw <- readRDS(file = paste0(data.raw_path, "/ramp/respiratory_coping_ramp.rds"))
...
++MD: Do we want to name the RAMP dataset something different, if the algorithm will need to be changed because they have categorical age and gender not sex? (otherwise can remove the if statement and rename the dataset 'dat.full' instead of dat.coping)
