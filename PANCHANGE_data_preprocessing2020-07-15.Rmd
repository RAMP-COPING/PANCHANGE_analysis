...
glad.pcl.raw.id <- glad.pcl.raw.id %>%
  mutate(
...
glad.ocir.raw.id <- glad.ocir.raw.id %>%
  mutate(
...
coping.glad.pcl.raw.id <- coping.glad.pcl.raw.id %>%
  mutate(
...
coping.glad.ocir.raw.id <- coping.glad.ocir.raw.id %>%
  mutate(
