...
nbr.mhd.raw.id_renamed <- nbr.mhd.raw.id %>% 
  ...
  add_column(
    mhd.schizoaffective_disorder = NA, #NBR dooesn't ask about schizoaffective
  ...
  mutate(
    psychotic_disorders_numeric =
      case_when(
        ...
        (mhd.schizoaffective_disorder_numeric == "0" | is.na(mhd.schizoaffective_disorder_numeric == "0") &
