...
#Correlation between whole sample retro impute and prepan
...
```{r Whole sample scatterplot for gad prepan base}
...
whole_retro_prepan_scatter <- dat %>% 
...
whole_retro_prepan_scatter %>% ggplot(aes(x = gad.sum_score_retro, y = gad.sum_score_retro)) +
...
#Correlation little/much worse prepan retro gad
...
```{r Little/much worse scatterplots for gad}
...
#Filter by little/much worse self-reported change since pandemic started in gad

much_worse_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "Much worse")

little_worse_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "A little worse")

much_little_worse_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "Much worse" | 
           gad.pandemic_felt_feelings == "A little worse")
...
```{r Little/much better scatterplots for gad}
...
#Filter by participants reporting little/much better in gad since pandemic started (separetely and grouped) 

little_better_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "A little better")

much_better_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "Much better")

much_little_better_gad_scatter <- dat %>% 
  filter(gad.pandemic_felt_feelings == "Much better" | 
           gad.pandemic_felt_feelings == "A little better")
