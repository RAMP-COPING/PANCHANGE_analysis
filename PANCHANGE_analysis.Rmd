...
```{r gad.sum violin plot Disorder_hierarchical, fig.height=10, fig.width=15}
dat.long.gad.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
            "Prepandemic" = "prepan",
            "Retrospective" = "retro",
...
```{r phq.sum violin plot Disorder_hierarchical, fig.height=10, fig.width=15}
dat.long.phq.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
...
```{r ocir.sum violin plot Disorder_hierarchical, fig.height=10, fig.width=15}
dat.long.ocir.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
