...
```{r forest plot by disorder no explan, fig.height=30, fig.width=50, dpi=120}
...
```{r forest plot by sample no explan gad, fig.height=30, fig.width=50, dpi=120}
...
```{r forest plot by sample no explan phq, fig.height=30, fig.width=50, dpi=120}
...
```{r forest plot by sample no explan pcl, fig.height=30, fig.width=50, dpi=120}
