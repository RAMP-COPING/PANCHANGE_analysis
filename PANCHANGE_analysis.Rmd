...
## Forest plots
### disorder
```{r forest plot by disorder prepan, fig.height=14, fig.width=8}

lm.forest(plot.dat.disorder.prepan,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro, fig.height=14, fig.width=8}
...
### disorder (no PCL)
```{r forest plot by disorder prepan no pcl, fig.height=14, fig.width=8}

lm.forest(plot.dat.disorder.prepan.gadphq,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro no pcl, fig.height=14, fig.width=8}
