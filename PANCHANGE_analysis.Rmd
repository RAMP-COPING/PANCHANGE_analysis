...
+++CHECK OVERLAP BETWEEN TESTS and probable COVID
...
dat <- dat %>%
  mutate(ocir.change_binary_numeric =
           case_when(
             ocir.pandemic_felt_feelings_numeric == 1 ~ 1,
             ocir.pandemic_felt_feelings_numeric == 2 ~ 1,
             ocir.pandemic_felt_feelings_numeric == 3 ~ 0,
             ocir.pandemic_felt_feelings_numeric == 4 ~ 2,
             ocir.pandemic_felt_feelings_numeric == 5 ~ 2
           )
  )
