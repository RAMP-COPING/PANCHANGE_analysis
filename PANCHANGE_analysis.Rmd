...
```{r function create formula for lin models}
...
model1b.lm.form("gad.sum_score_base", "gad.sum_score_prepan", dat.prepan)
model1b.lm.form("gad.sum_score_base", "gad.sum_score_retro", dat.retro)

model1b.lm.form("phq.sum_score_base", "phq.sum_score_prepan", dat.prepan)
model1b.lm.form("phq.sum_score_base", "phq.sum_score_retro", dat.retro)

model1b.lm.form("pcl.sum_score_base", "pcl.sum_score_prepan", dat.prepan)
model1b.lm.form("pcl.sum_score_base", "pcl.sum_score_retro", dat.retro)
...
```{r function to create data for lm forest plots}
...
```{r function for creating forest plots}
...
## Forest plots
### disorder
```{r forest plot by disorder prepan, fig.height=20, fig.width=12}

lm.forest(plot.dat.disorder.prepan,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro, fig.height=20, fig.width=12}
...
### disorder (no PCL)
```{r forest plot by disorder prepan no pcl, fig.height=20, fig.width=12}

lm.forest(plot.dat.disorder.prepan.gadphq,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro no pcl, fig.height=20, fig.width=12}
...
```{r forest plot by time point pcl, fig.height=14, fig.width=8}
