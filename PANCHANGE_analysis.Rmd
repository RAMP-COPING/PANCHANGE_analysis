...
## Forest plots
### disorder
```{r forest plot by disorder prepan, fig.height=30, fig.width=35, dpi=120}

lm.forest(plot.dat.disorder.prepan,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro, fig.height=30, fig.width=30, dpi=120}
...
### disorder (no PCL)
```{r forest plot by disorder prepan no pcl, fig.height=30, fig.width=30, dpi=120}

lm.forest(plot.dat.disorder.prepan.gadphq,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro no pcl, fig.height=30, fig.width=30, dpi=120}
...
### time point 
```{r forest plot by time point gad, fig.height=30, fig.width=30, dpi=120}

lm.forest(plot.dat.time.gad,"Predictors of anxiety during pandemic controlling for retrospective or prepandemic symptoms")

```

```{r forest plot by time point phq, fig.height=30, fig.width=30, dpi=120}
...
```{r forest plot by time point pcl, fig.height=30, fig.width=30, dpi=120}
...
```{r forest plot by sample retro only gad, fig.height=30, fig.width=30, dpi=120}

lm.forest(plot.dat.sample.gad ,"Predictors of anxiety controlling for retrospective symptoms across samples")

```

```{r forest plot by sample retro only phq, fig.height=30, fig.width=30, dpi=120}

lm.forest(plot.dat.sample.phq ,"Predictors of depression controlling for retrospective symptoms across samples")

```

```{r forest plot by sample retro only pcl, fig.height=30, fig.width=30, dpi=120}
