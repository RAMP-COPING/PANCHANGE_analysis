...
++CH: need to discuss exclusion criteria
...
++CH: exclusion criteria need double checking
...
```{r}
model0a.estimates(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
model0a.reg.stats(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
```
...
model0b.estimates <- function(outcome, data_set) {
  ...
  dependent.variable <- outcome
  # define the independent variables
  independent.variables <- c("anxiety_disorders",
...
```{r}
model0b.estimates(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
model0b.reg.stats(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
```
...
```{r}
model1a.estimates(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
model1a.reg.stats(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
```
...
```{r}
model1b.estimates(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
model1b.reg.stats(outcome = "gad.diff_score_base_prepan", data_set = "dat.prepan")
```
...
```{r}
model0a.explan.estimates(outcome = "gad.diff_score_base_prepan", explan_var = "gad.sum_score_retro", data_set = "dat.prepan")
model0a.explan.reg.stats(outcome = "gad.diff_score_base_prepan", explan_var = "gad.sum_score_retro", data_set = "dat.prepan")
```
