...
## age_category_full
```{r Inspect age_category_full}
dat.raw %>%
  freq(age_category_full)

dat.raw %>%
  freq(age_category_full_numeric)
```

```{r Collapse age_category_full}
dat.raw <- dat.raw %>%
  mutate(age_category_collapsed_numeric =
           case_when(
             age_category_full_numeric == 1 ~ 0,
             age_category_full_numeric == 2 ~ 1,
             age_category_full_numeric == 3 ~ 2,
             age_category_full_numeric == 4 ~ 3,
             age_category_full_numeric == 5 ~ 4,
             age_category_full_numeric == 6 ~ 5,
             age_category_full_numeric == 7 ~ 6,
             age_category_full_numeric == 8 ~ 7,
             age_category_full_numeric == 9 ~ 9,
             age_category_full_numeric == 10 ~ 9,
             age_category_full_numeric == 11 ~ 9,
             age_category_full_numeric == 12 ~ 9,
             age_category_full_numeric == 13 ~ 9
