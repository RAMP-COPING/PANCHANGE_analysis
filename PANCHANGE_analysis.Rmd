...
```{r gad.sum violin plot Sample, fig.height=3.5, fig.width=2.5}
dat.long.gad.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
            "Prepandemic" = "prepan",
            "Retrospective" = "retro",
...
```{r gad.sum violin plot Disorder_hierarchical}
dat.long.gad.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
            "Prepandemic" = "prepan",
            "Retrospective" = "retro",
...
```{r phq.sum violin plot Sample, fig.height=3.5, fig.width=2.5}
dat.long.phq.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
...
```{r phq.sum violin plot Disorder_hierarchical}
dat.long.phq.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
...
```{r ocir.sum violin plot Sample, fig.height=3.5, fig.width=2.5}
dat.long.ocir.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
...
```{r ocir.sum violin plot Disorder_hierarchical}
dat.long.ocir.sum %>%
  mutate(Time_point_renamed = fct_recode(Time_point, 
                                         "Prepandemic" = "prepan",
                                         "Retrospective" = "retro",
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad education sensitivity model0a sum_score prepan}
# Regression coefficients
gad_prepan_model0a_education_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_education_estimates)
gad_prepan_model0a_education_estimates

# Regression diagnostic statistics
gad_prepan_model0a_education_reg_stats <- model0a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_education_reg_stats)
gad_prepan_model0a_education_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r gad education sensitivity model0b sum_score prepan}
# Regression coefficients
gad_prepan_model0b_education_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_education_estimates)
gad_prepan_model0b_education_estimates

# Regression diagnostic statistics
gad_prepan_model0b_education_reg_stats <- model0b.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_education_reg_stats)
gad_prepan_model0b_education_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad education sensitivity model1a sum_score prepan}
# Regression coefficients
gad_prepan_model1a_education_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_education_estimates)
gad_prepan_model1a_education_estimates

# Regression diagnostic statistics
gad_prepan_model1a_education_reg_stats <- model1a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_education_reg_stats)
gad_prepan_model1a_education_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq education sensitivity model0a sum_score prepan}
# Regression coefficients
phq_prepan_model0a_education_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_education_estimates)
phq_prepan_model0a_education_estimates

# Regression diagnostic statistics
phq_prepan_model0a_education_reg_stats <- model0a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_education_reg_stats)
phq_prepan_model0a_education_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r phq education sensitivity model0b sum_score prepan}
# Regression coefficients
phq_prepan_model0b_education_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_education_estimates)
phq_prepan_model0b_education_estimates

# Regression diagnostic statistics
phq_prepan_model0b_education_reg_stats <- model0b.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_education_reg_stats)
phq_prepan_model0b_education_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq education sensitivity model1a sum_score prepan}
# Regression coefficients
phq_prepan_model1a_education_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_education_estimates)
phq_prepan_model1a_education_estimates

# Regression diagnostic statistics
phq_prepan_model1a_education_reg_stats <- model1a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_education_reg_stats)
phq_prepan_model1a_education_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir education sensitivity model0a sum_score prepan}
# Regression coefficients
ocir_prepan_model0a_education_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_education_estimates)
ocir_prepan_model0a_education_estimates

# Regression diagnostic statistics
ocir_prepan_model0a_education_reg_stats <- model0a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_education_reg_stats)
ocir_prepan_model0a_education_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r ocir education sensitivity model0b sum_score prepan}
# Regression coefficients
ocir_prepan_model0b_education_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_education_estimates)
ocir_prepan_model0b_education_estimates

# Regression diagnostic statistics
ocir_prepan_model0b_education_reg_stats <- model0b.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_education_reg_stats)
ocir_prepan_model0b_education_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir education sensitivity model1a sum_score prepan}
# Regression coefficients
ocir_prepan_model1a_education_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_education_estimates)
ocir_prepan_model1a_education_estimates

# Regression diagnostic statistics
ocir_prepan_model1a_education_reg_stats <- model1a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_education_reg_stats)
ocir_prepan_model1a_education_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl education sensitivty model0a sum_score prepan}
# Regression coefficients
pcl_prepan_model0a_education_estimates <- model0a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_education_estimates)
pcl_prepan_model0a_education_estimates

# Regression diagnostic statistics
pcl_prepan_model0a_education_reg_stats <- model0a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_education_reg_stats)
pcl_prepan_model0a_education_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r pcl education sensitivty model0b sum_score prepan}
# Regression coefficients
pcl_prepan_model0b_education_estimates <- model0b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_education_estimates)
pcl_prepan_model0b_education_estimates

# Regression diagnostic statistics
pcl_prepan_model0b_education_reg_stats <- model0b.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_education_reg_stats)
pcl_prepan_model0b_education_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl education sensitivty model1a sum_score prepan}
# Regression coefficients
pcl_prepan_model1a_education_estimates <- model1a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_education_estimates)
pcl_prepan_model1a_education_estimates

# Regression diagnostic statistics
pcl_prepan_model1a_education_reg_stats <- model1a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "highest_education",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_education_reg_stats)
pcl_prepan_model1a_education_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad employment sensitivity model0a sum_score prepan}
# Regression coefficients
gad_prepan_model0a_employment_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed_numeric",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_employment_estimates)
gad_prepan_model0a_employment_estimates

# Regression diagnostic statistics
gad_prepan_model0a_employment_reg_stats <- model0a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed_numeric",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_employment_reg_stats)
gad_prepan_model0a_employment_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r gad employment sensitivity model0b sum_score prepan}
# Regression coefficients
gad_prepan_model0b_employment_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_employment_estimates)
gad_prepan_model0b_employment_estimates

# Regression diagnostic statistics
gad_prepan_model0b_employment_reg_stats <- model0b.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_employment_reg_stats)
gad_prepan_model0b_employment_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad employment sensitivity model1a sum_score prepan}
# Regression coefficients
gad_prepan_model1a_employment_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_employment_estimates)
gad_prepan_model1a_employment_estimates

# Regression diagnostic statistics
gad_prepan_model1a_employment_reg_stats <- model1a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_employment_reg_stats)
gad_prepan_model1a_employment_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq employment sensitivity model0a sum_score prepan}
# Regression coefficients
phq_prepan_model0a_employment_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_employment_estimates)
phq_prepan_model0a_employment_estimates

# Regression diagnostic statistics
phq_prepan_model0a_employment_reg_stats <- model0a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_employment_reg_stats)
phq_prepan_model0a_employment_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r phq employment sensitivity model0b sum_score prepan}
# Regression coefficients
phq_prepan_model0b_employment_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_employment_estimates)
phq_prepan_model0b_employment_estimates

# Regression diagnostic statistics
phq_prepan_model0b_employment_reg_stats <- model0b.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_employment_reg_stats)
phq_prepan_model0b_employment_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq employment sensitivity model1a sum_score prepan}
# Regression coefficients
phq_prepan_model1a_employment_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_employment_estimates)
phq_prepan_model1a_employment_estimates

# Regression diagnostic statistics
phq_prepan_model1a_employment_reg_stats <- model1a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_employment_reg_stats)
phq_prepan_model1a_employment_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir employment sensitivity model0a sum_score prepan}
# Regression coefficients
ocir_prepan_model0a_employment_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_employment_estimates)
ocir_prepan_model0a_employment_estimates

# Regression diagnostic statistics
ocir_prepan_model0a_employment_reg_stats <- model0a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_employment_reg_stats)
ocir_prepan_model0a_employment_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r ocir employment sensitivity model0b sum_score prepan}
# Regression coefficients
ocir_prepan_model0b_employment_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_employment_estimates)
ocir_prepan_model0b_employment_estimates

# Regression diagnostic statistics
ocir_prepan_model0b_employment_reg_stats <- model0b.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_employment_reg_stats)
ocir_prepan_model0b_employment_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir employment sensitivity model1a sum_score prepan}
# Regression coefficients
ocir_prepan_model1a_employment_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_employment_estimates)
ocir_prepan_model1a_employment_estimates

# Regression diagnostic statistics
ocir_prepan_model1a_employment_reg_stats <- model1a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_employment_reg_stats)
ocir_prepan_model1a_employment_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl employment sensitivty model0a sum_score prepan}
# Regression coefficients
pcl_prepan_model0a_employment_estimates <- model0a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_employment_estimates)
pcl_prepan_model0a_employment_estimates

# Regression diagnostic statistics
pcl_prepan_model0a_employment_reg_stats <- model0a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_employment_reg_stats)
pcl_prepan_model0a_employment_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r pcl employment sensitivty model0b sum_score prepan}
# Regression coefficients
pcl_prepan_model0b_employment_estimates <- model0b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_employment_estimates)
pcl_prepan_model0b_employment_estimates

# Regression diagnostic statistics
pcl_prepan_model0b_employment_reg_stats <- model0b.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_employment_reg_stats)
pcl_prepan_model0b_employment_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl employment sensitivty model1a sum_score prepan}
# Regression coefficients
pcl_prepan_model1a_employment_estimates <- model1a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_employment_estimates)
pcl_prepan_model1a_employment_estimates

# Regression diagnostic statistics
pcl_prepan_model1a_employment_reg_stats <- model1a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment.unemployed",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_employment_reg_stats)
pcl_prepan_model1a_employment_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad employment change sensitivity model0a sum_score prepan}
# Regression coefficients
gad_prepan_model0a_employmentchange_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_employmentchange_estimates)
gad_prepan_model0a_employmentchange_estimates

# Regression diagnostic statistics
gad_prepan_model0a_employmentchange_reg_stats <- model0a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model0a_employmentchange_reg_stats)
gad_prepan_model0a_employmentchange_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r gad employment change sensitivity model0b sum_score prepan}
# Regression coefficients
gad_prepan_model0b_employmentchange_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_employmentchange_estimates)
gad_prepan_model0b_employmentchange_estimates

# Regression diagnostic statistics
gad_prepan_model0b_employmentchange_reg_stats <- model0b.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model0b_employmentchange_reg_stats)
gad_prepan_model0b_employmentchange_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad employment change sensitivity model1a sum_score prepan}
# Regression coefficients
gad_prepan_model1a_employmentchange_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_employmentchange_estimates)
gad_prepan_model1a_employmentchange_estimates

# Regression diagnostic statistics
gad_prepan_model1a_employmentchange_reg_stats <- model1a.explan.reg.stats(outcome = "gad.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(gad_prepan_model1a_employmentchange_reg_stats)
gad_prepan_model1a_employmentchange_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq employment change sensitivity model0a sum_score prepan}
# Regression coefficients
phq_prepan_model0a_employmentchange_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_employmentchange_estimates)
phq_prepan_model0a_employmentchange_estimates

# Regression diagnostic statistics
phq_prepan_model0a_employmentchange_reg_stats <- model0a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model0a_employmentchange_reg_stats)
phq_prepan_model0a_employmentchange_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r phq employment change sensitivity model0b sum_score prepan}
# Regression coefficients
phq_prepan_model0b_employmentchange_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_employmentchange_estimates)
phq_prepan_model0b_employmentchange_estimates

# Regression diagnostic statistics
phq_prepan_model0b_employmentchange_reg_stats <- model0b.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model0b_employmentchange_reg_stats)
phq_prepan_model0b_employmentchange_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq employment change sensitivity model1a sum_score prepan}
# Regression coefficients
phq_prepan_model1a_employmentchange_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_employmentchange_estimates)
phq_prepan_model1a_employmentchange_estimates

# Regression diagnostic statistics
phq_prepan_model1a_employmentchange_reg_stats <- model1a.explan.reg.stats(outcome = "phq.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(phq_prepan_model1a_employmentchange_reg_stats)
phq_prepan_model1a_employmentchange_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir employment change sensitivity model0a sum_score prepan}
# Regression coefficients
ocir_prepan_model0a_employmentchange_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_employmentchange_estimates)
ocir_prepan_model0a_employmentchange_estimates

# Regression diagnostic statistics
ocir_prepan_model0a_employmentchange_reg_stats <- model0a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0a_employmentchange_reg_stats)
ocir_prepan_model0a_employmentchange_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r ocir employment change sensitivity model0b sum_score prepan}
# Regression coefficients
ocir_prepan_model0b_employmentchange_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_employmentchange_estimates)
ocir_prepan_model0b_employmentchange_estimates

# Regression diagnostic statistics
ocir_prepan_model0b_employmentchange_reg_stats <- model0b.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model0b_employmentchange_reg_stats)
ocir_prepan_model0b_employmentchange_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir employment change sensitivity model1a sum_score prepan}
# Regression coefficients
ocir_prepan_model1a_employmentchange_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_employmentchange_estimates)
ocir_prepan_model1a_employmentchange_estimates

# Regression diagnostic statistics
ocir_prepan_model1a_employmentchange_reg_stats <- model1a.explan.reg.stats(outcome = "ocir.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(ocir_prepan_model1a_employmentchange_reg_stats)
ocir_prepan_model1a_employmentchange_reg_stats
```
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl employment change sensitivty model0a sum_score prepan}
# Regression coefficients
pcl_prepan_model0a_employmentchange_estimates <- model0a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_employmentchange_estimates)
pcl_prepan_model0a_employmentchange_estimates

# Regression diagnostic statistics
pcl_prepan_model0a_employmentchange_reg_stats <- model0a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0a_employmentchange_reg_stats)
pcl_prepan_model0a_employmentchange_reg_stats
```

### Model 0b: Overlapping disorders, Unadjusted
```{r pcl employment change sensitivty model0b sum_score prepan}
# Regression coefficients
pcl_prepan_model0b_employmentchange_estimates <- model0b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_employmentchange_estimates)
pcl_prepan_model0b_employmentchange_estimates

# Regression diagnostic statistics
pcl_prepan_model0b_employmentchange_reg_stats <- model0b.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model0b_employmentchange_reg_stats)
pcl_prepan_model0b_employmentchange_reg_stats
```

### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl employment change sensitivty model1a sum_score prepan}
# Regression coefficients
pcl_prepan_model1a_employmentchange_estimates <- model1a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_employmentchange_estimates)
pcl_prepan_model1a_employmentchange_estimates

# Regression diagnostic statistics
pcl_prepan_model1a_employmentchange_reg_stats <- model1a.explan.reg.stats(outcome = "pcl.sum_score_base",
                         explan_var = "employment_change",
                         data_set = "dat.prepan")
kable(pcl_prepan_model1a_employmentchange_reg_stats)
pcl_prepan_model1a_employmentchange_reg_stats
```
...
```{r model0a.explan education function}
model0a.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
```{r model0b.explan education function}
model0b.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
```{r model1a.explan education function}
model1a.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a diff_score w/education prepan}
# Regression coefficients
gad_prepan_model0a_estimates <- model0a.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b diff_score w/education prepan}
# Regression coefficients
gad_prepan_model0b_estimates <- model0b.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a diff_score w/education prepan}
# Regression coefficients
gad_prepan_model1a_estimates <- model1a.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b diff_score w/education prepan}
# Regression coefficients
gad_prepan_model1b_estimates <- model1b.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a sum_score w/education prepan}
# Regression coefficients
gad_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b sum_score w/education prepan}
# Regression coefficients
gad_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a sum_score w/education prepan}
# Regression coefficients
gad_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b sum_score w/education prepan}
# Regression coefficients
gad_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a diff_score w/education retro}
# Regression coefficients
gad_retro_model0a_estimates <- model0a.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b diff_score w/education retro}
# Regression coefficients
gad_retro_model0b_estimates <- model0b.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a diff_score w/education retro}
# Regression coefficients
gad_retro_model1a_estimates <- model1a.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b diff_score w/education retro}
# Regression coefficients
gad_retro_model1b_estimates <- model1b.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a sum_score w/education retro}
# Regression coefficients
gad_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b sum_score w/education retro}
# Regression coefficients
gad_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a sum_score w/education retro}
# Regression coefficients
gad_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b sum_score w/education retro}
# Regression coefficients
gad_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a diff_score w/education prepan}
# Regression coefficients
phq_prepan_model0a_estimates <- model0a.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b diff_score w/education prepan}
# Regression coefficients
phq_prepan_model0b_estimates <- model0b.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a diff_score w/education prepan}
# Regression coefficients
phq_prepan_model1a_estimates <- model1a.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b diff_score w/education prepan}
# Regression coefficients
phq_prepan_model1b_estimates <- model1b.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a sum_score w/education prepan}
# Regression coefficients
phq_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b sum_score w/education prepan}
# Regression coefficients
phq_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a sum_score w/education prepan}
# Regression coefficients
phq_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b sum_score w/education prepan}
# Regression coefficients
phq_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a diff_score w/education retro}
# Regression coefficients
phq_retro_model0a_estimates <- model0a.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b diff_score w/education retro}
# Regression coefficients
phq_retro_model0b_estimates <- model0b.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a diff_score w/education retro}
# Regression coefficients
phq_retro_model1a_estimates <- model1a.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b diff_scor w/educatione retro}
# Regression coefficients
phq_retro_model1b_estimates <- model1b.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a sum_score w/education retro}
# Regression coefficients
phq_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b sum_score w/education retro}
# Regression coefficients
phq_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a sum_score w/education retro}
# Regression coefficients
phq_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b sum_score w/education retro}
# Regression coefficients
phq_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a diff_score w/education prepan}
# Regression coefficients
ocir_prepan_model0a_estimates <- model0a.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b diff_score w/education prepan}
# Regression coefficients
ocir_prepan_model0b_estimates <- model0b.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a diff_score w/education prepan}
# Regression coefficients
ocir_prepan_model1a_estimates <- model1a.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b diff_score w/education prepan}
# Regression coefficients
ocir_prepan_model1b_estimates <- model1b.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a sum_score w/education prepan}
# Regression coefficients
ocir_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b sum_score w/education prepan}
# Regression coefficients
ocir_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a sum_score w/education prepan}
# Regression coefficients
ocir_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b sum_score w/education prepan}
# Regression coefficients
ocir_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a diff_score w/education retro}
# Regression coefficients
ocir_retro_model0a_estimates <- model0a.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b diff_score w/education retro}
# Regression coefficients
ocir_retro_model0b_estimates <- model0b.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a diff_score w/education retro}
# Regression coefficients
ocir_retro_model1a_estimates <- model1a.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b diff_score w/education retro}
# Regression coefficients
ocir_retro_model1b_estimates <- model1b.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a sum_score w/education retro}
# Regression coefficients
ocir_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b sum_score w/education retro}
# Regression coefficients
ocir_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a sum_score w/education retro}
# Regression coefficients
ocir_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b sum_score w/education retro}
# Regression coefficients
ocir_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl model0a diff_score w/education prepan}
# Regression coefficients
pcl_prepan_model0a_estimates <- model0a.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r pcl model0b diff_score w/education prepan}
# Regression coefficients
pcl_prepan_model0b_estimates <- model0b.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1a diff_score w/education prepan}
# Regression coefficients
pcl_prepan_model1a_estimates <- model1a.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1b diff_score w/education prepan}
# Regression coefficients
pcl_prepan_model1b_estimates <- model1b.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl model0a sum_score w/education prepan}
# Regression coefficients
pcl_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r pcl model0b sum_score w/education prepan}
# Regression coefficients
pcl_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1a sum_score w/education prepan}
# Regression coefficients
pcl_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1b sum_score w/education prepan}
# Regression coefficients
pcl_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
         ...
         tidy(get(paste0(outcome,".model0a")), conf.int = TRUE) %>%
           mutate(
             "Indepent variable" = recode_factor(
               ...
               "Disorder_hierarchicalDepressive disorders" = "Depressive disorders",
               "Disorder_hierarchicalBipolar disorders" = "Bipolar disorders", 
               "employment.unemployedUnemployed" = "Unemployed", 
               "employment.unemployedNot Unemployed" = "Not unemployed"
             ),
    "Estimate" = format(
      round(estimate,
            digits = 2),
...
```{r model0a.explan employment function}
model0a.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
```{r model0b.explan employment function}
model0b.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
```{r model1a.explan employment function}
model1a.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
```{r model1b.explan employment function}
model1b.explan.estimates <- function(outcome, explan_var, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a diff_score w/employment prepan}
# Regression coefficients
gad_prepan_model0a_estimates <- model0a.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b diff_score w/employment prepan}
# Regression coefficients
gad_prepan_model0b_estimates <- model0b.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a diff_score w/employment prepan}
# Regression coefficients
gad_prepan_model1a_estimates <- model1a.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b diff_score w/employment prepan}
# Regression coefficients
gad_prepan_model1b_estimates <- model1b.estimates(outcome = "gad.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(gad_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a sum_score w/employment prepan}
# Regression coefficients
gad_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b sum_score w/employment prepan}
# Regression coefficients
gad_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a sum_score w/employment prepan}
# Regression coefficients
gad_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b sum_score w/employment prepan}
# Regression coefficients
gad_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "gad.sum_score_base",
                         explan_var = "gad.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a diff_score w/employment retro}
# Regression coefficients
gad_retro_model0a_estimates <- model0a.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b diff_score w/employment retro}
# Regression coefficients
gad_retro_model0b_estimates <- model0b.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a diff_score w/employment retro}
# Regression coefficients
gad_retro_model1a_estimates <- model1a.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b diff_score w/employment retro}
# Regression coefficients
gad_retro_model1b_estimates <- model1b.estimates(outcome = "gad.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(gad_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r gad model0a sum_score w/employment retro}
# Regression coefficients
gad_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r gad model0b sum_score w/employment retro}
# Regression coefficients
gad_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1a sum_score w/employment retro}
# Regression coefficients
gad_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r gad model1b sum_score w/employment retro}
# Regression coefficients
gad_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "gad.sum_score_base",
                                                               explan_var = "gad.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a diff_score w/employment prepan}
# Regression coefficients
phq_prepan_model0a_estimates <- model0a.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b diff_score w/employment prepan}
# Regression coefficients
phq_prepan_model0b_estimates <- model0b.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a diff_score w/employment prepan}
# Regression coefficients
phq_prepan_model1a_estimates <- model1a.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b diff_score w/employment prepan}
# Regression coefficients
phq_prepan_model1b_estimates <- model1b.estimates(outcome = "phq.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(phq_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a sum_score w/employment prepan}
# Regression coefficients
phq_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b sum_score w/employment prepan}
# Regression coefficients
phq_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a sum_score w/employment prepan}
# Regression coefficients
phq_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b sum_score w/employment prepan}
# Regression coefficients
phq_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "phq.sum_score_base",
                         explan_var = "phq.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a diff_score w/employment retro}
# Regression coefficients
phq_retro_model0a_estimates <- model0a.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b diff_score w/employment retro}
# Regression coefficients
phq_retro_model0b_estimates <- model0b.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a diff_score w/employment retro}
# Regression coefficients
phq_retro_model1a_estimates <- model1a.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b diff_score w/employment retro}
# Regression coefficients
phq_retro_model1b_estimates <- model1b.estimates(outcome = "phq.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(phq_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r phq model0a sum_score w/employment retro}
# Regression coefficients
phq_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r phq model0b sum_score w/employment retro}
# Regression coefficients
phq_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1a sum_score w/employment retro}
# Regression coefficients
phq_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r phq model1b sum_score w/employment retro}
# Regression coefficients
phq_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "phq.sum_score_base",
                                                               explan_var = "phq.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a diff_score w/employment prepan}
# Regression coefficients
ocir_prepan_model0a_estimates <- model0a.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b diff_score w/employment prepan}
# Regression coefficients
ocir_prepan_model0b_estimates <- model0b.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a diff_score w/employment prepan}
# Regression coefficients
ocir_prepan_model1a_estimates <- model1a.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b diff_score w/employment prepan}
# Regression coefficients
ocir_prepan_model1b_estimates <- model1b.estimates(outcome = "ocir.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(ocir_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a sum_score w/employment prepan}
# Regression coefficients
ocir_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b sum_score w/employment prepan}
# Regression coefficients
ocir_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a sum_score w/employment prepan}
# Regression coefficients
ocir_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b sum_score w/employment prepan}
# Regression coefficients
ocir_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "ocir.sum_score_base",
                         explan_var = "ocir.sum_score_prepan",
                         data_set = "dat.prepan")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a diff_score w/employment retro}
# Regression coefficients
ocir_retro_model0a_estimates <- model0a.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b diff_score w/employment retro}
# Regression coefficients
ocir_retro_model0b_estimates <- model0b.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a diff_score w/employment retro}
# Regression coefficients
ocir_retro_model1a_estimates <- model1a.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b diff_score w/employment retro}
# Regression coefficients
ocir_retro_model1b_estimates <- model1b.estimates(outcome = "ocir.diff_score_base_retro",
                                                 data_set = "dat.retro")
kable(ocir_retro_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r ocir model0a sum_score w/employment retro}
# Regression coefficients
ocir_retro_model0a_explan_estimates <- model0a.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r ocir model0b sum_score w/employment retro}
# Regression coefficients
ocir_retro_model0b_explan_estimates <- model0b.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1a sum_score w/employment retro}
# Regression coefficients
ocir_retro_model1a_explan_estimates <- model1a.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r ocir model1b sum_score w/employment retro}
# Regression coefficients
ocir_retro_model1b_explan_estimates <- model1b.explan.estimates(outcome = "ocir.sum_score_base",
                                                               explan_var = "ocir.sum_score_retro",
                                                               data_set = "dat.retro")
...
## Regression: Change scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl model0a diff_score w/employment prepan}
# Regression coefficients
pcl_prepan_model0a_estimates <- model0a.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model0a_estimates)
...
### Model 0b: Overlapping disorders, Unadjusted
```{r pcl model0b diff_score w/employment prepan}
# Regression coefficients
pcl_prepan_model0b_estimates <- model0b.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model0b_estimates)
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1a diff_score w/employment prepan}
# Regression coefficients
pcl_prepan_model1a_estimates <- model1a.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model1a_estimates)
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1b diff_score w/employment prepan}
# Regression coefficients
pcl_prepan_model1b_estimates <- model1b.estimates(outcome = "pcl.diff_score_base_prepan",
                  data_set = "dat.prepan")
kable(pcl_prepan_model1b_estimates)
...
## Regression: Absolute scores
### Model 0a: Disorder_hierarchical, Unadjusted
```{r pcl model0a sum_score w/employment prepan}
# Regression coefficients
pcl_prepan_model0a_explan_estimates <- model0a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 0b: Overlapping disorders, Unadjusted
```{r pcl model0b sum_score w/employment prepan}
# Regression coefficients
pcl_prepan_model0b_explan_estimates <- model0b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1a: Disorder hierarchical, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1a sum_score w/employment prepan}
# Regression coefficients
pcl_prepan_model1a_explan_estimates <- model1a.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
...
### Model 1b: Overlapping disorders, Adjusted
Model 0a + Gender_collapsed + age_category_collapsed + Ethnicity_collapsed + Time registration and baseline
```{r pcl model1b sum_score w/employment prepan}
# Regression coefficients
pcl_prepan_model1b_explan_estimates <- model1b.explan.estimates(outcome = "pcl.sum_score_base",
                         explan_var = "pcl.sum_score_prepan",
                         data_set = "dat.prepan")
