...
++MD: Do we want to break up the datasets by cohort again? Or is this breaking up datasets into GAD
...
Filter data frame to create 3 datasets:
  ...
  1. Retrospective - baseline change anlyses
        i. Exclude individuals with NAs for:
              ...
              2. Age
              3. Gender
              4. Missing retrospective and/or baseline data
  2. Prepandemic - baseline change analyses
          i. Exclude individuals with NAs for:
              1. MHD
              2. Age
              3. Gender
              4. Missing pandemic and/or baseline data
