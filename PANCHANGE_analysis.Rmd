...
# function to return standardised beta for plotting in a dataframe

model1b.lm <- function(outcome, data_set) {
  # define the variable name of the dependent variable
  dependent.variable <- outcome
  # define the independent variables
  independent.variables <- c("depression_and_anxiety",
  ...
  # run the glm
  assign(paste0(outcome,".model1b.lm"),
         lm( formula = glm.formula,
             data = get(data_set)
         )
  )

  return(get(paste0(outcome,".model1b.lm")))
}
...
# get lm object to standardise beta
