...
## Forest plots
### disorder
```{r forest plot by disorder prepan, fig.height=40, fig.width=60, dpi=120}

lm.forest(plot.dat.disorder.prepan,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by disorder no explan, fig.height=40, fig.width=60, dpi=120}
...
### disorder (no PCL)
```{r forest plot by disorder prepan no pcl, fig.height=40, fig.width=60, dpi=120}

lm.forest(plot.dat.disorder.prepan.gadphq,"Predictors of pandemic symptoms controlling for prepandemic symptoms")

```

```{r forest plot by disorder retro no pcl, fig.height=40, fig.width=60, dpi=120}
...
### time point 
```{r forest plot by time point gad, fig.height=40, fig.width=60, dpi=120}

lm.forest(plot.dat.time.gad,"Predictors of anxiety during pandemic controlling for retrospective or prepandemic symptoms")

```

```{r forest plot by time point phq, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by time point pcl, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by sample retro only gad, fig.height=40, fig.width=60, dpi=120}

lm.forest(plot.dat.sample.gad ,"Predictors of anxiety controlling for retrospective symptoms across samples")

```

```{r forest plot by sample retro only phq, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by sample no explan gad, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by sample no explan phq, fig.height=40, fig.width=60, dpi=120}
...
```{r forest plot by sample no explan pcl, fig.height=40, fig.width=60, dpi=120}
