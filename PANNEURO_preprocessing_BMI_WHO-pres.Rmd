...
nbr.bmi.raw$Sample <- c("NBR")

nbr.bmi.raw$height.2[ nbr.bmi.raw$height.2>300 ] <- NA
nbr.bmi.raw$height.2[ nbr.bmi.raw$height.2<20 ] <- NA
nbr.bmi.raw$height.1[ nbr.bmi.raw$height.1>15 ] <- NA
nbr.bmi.raw$height.1[ nbr.bmi.raw$height.1<0.1 ] <- NA
nbr.bmi.raw$height[ nbr.bmi.raw$height>15 ] <- NA
nbr.bmi.raw$height[ nbr.bmi.raw$height<0.1 ] <- NA
...
glad.bmi.raw$height[ glad.bmi.raw$height>300 ] <- NA
glad.bmi.raw$height[ glad.bmi.raw$height<20 ] <- NA
glad.bmi.raw$height.1[ glad.bmi.raw$height.1>15 ] <- NA
glad.bmi.raw$height.1[ glad.bmi.raw$height.1<0.1 ] <- NA
glad.bmi.raw$height.2[ glad.bmi.raw$height.2>15 ] <- NA
glad.bmi.raw$height.2[ glad.bmi.raw$height.2<0.1 ] <- NA
...
edgi.bmi.raw$height.2[ edgi.bmi.raw$height.2>300 ] <- NA
edgi.bmi.raw$height.2[ edgi.bmi.raw$height.2<20 ] <- NA
edgi.bmi.raw$height.1[ edgi.bmi.raw$height.1>15 ] <- NA
edgi.bmi.raw$height.1[ edgi.bmi.raw$height.1<0.1 ] <- NA
edgi.bmi.raw$height[ edgi.bmi.raw$height>15 ] <- NA
edgi.bmi.raw$height[ edgi.bmi.raw$height<0.1 ] <- NA
