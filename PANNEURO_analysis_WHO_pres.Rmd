...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.watching_tv) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sitting_inactive_in_a_public_place) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.break_passenger_car_hour) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.afternoon_rest_circumstances_lying) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sitting_and_talking_to_someone) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sitting_quietly_after_a_lunch_without_alcohol) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.car_minutes_stopped_traffic) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.insomnia) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.narcolepsy) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.rem_sleep_behaviour_disorder) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.restless_legs_syndrome) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sleep_apnea) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sleep_terrors) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, ess.sleepwalking) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.headaches_suffered_past_month) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.days_past_month_miss_work_school) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.days_past_month_work_school_half_productivity) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.days_past_month_miss_housework) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.days_past_month_housework_half_productivity) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, midas.days_past_month_miss_social_activities) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmss.ability_taste_food_smell) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmss.severe_taste_smell_loss) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.drink_problems_choking_difficulty) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.regularly_night_pass_urine) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.sex_difficult_finding) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.weak_standing_feeling_light) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.acting_moving_sleep_talking) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, nmsw.double_vision) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, tinnitus.ears_noises_minutes_head) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, tinnitus.ears_noises_minutes_head_frequency) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
dat.raw %>%
  ...
  group_by(covid_test_positive) %>%
  count(covid_test_positive, tinnitus.noises_worry_worst_upset) %>%
  mutate(Prop = round(n/sum(n), 2))
```
...
```{r}
dat.raw <- dat.raw %>% 
  filter(ess.felt_excessively_sleepy_past_numeric == 1) %>%
  mutate(ess.sum_score = 
           rowSums(select(.,nmsw.col.names), na.rm = FALSE)
           )
